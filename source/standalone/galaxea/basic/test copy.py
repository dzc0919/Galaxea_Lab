...
# def run_simulator(sim: sim_utils.SimulationContext, scene: InteractiveScene):
    ...
    gripper_thickness = [-0.2 , -0.0157 , 0.03]
    ...
    ([0.3864, -0.3657, 1.1475], [1.0, 0.0, 0.0, 0.0], None),
    ([0.3864, -0.3657, 1.1475], [0.9970, 0.0, 0.0768, 0.0], None),
    ([0.3864, -0.3657, 1.1475], [0.9608, 0.0, 0.2773, 0.0], None),
    ([0.3864, -0.3657, 1.1475], [0.8996, 0.0, 0.4367, 0.0], None),
    ([0.3864, -0.3657, 1.1475], [0.7918, 0.0, 0.6108, 0.0], None),
    ([0.3864, -0.3657, 1.1475], [0.7576, 0.0, 0.6527, 0.0], None),
    ([0.3756, -0.3657, 1.1475], [0.7576, 0.0, 0.6527, 0.0], None),
    ([0.3756, -0.3657, 1.0419], [0.7576, 0.0, 0.6527, 0.0], None),
    ([0.3756, -0.3657, 1.0229], [0.7576, 0.0, 0.6527, 0.0], None),
    ([0.3756, -0.3657, 1.0], [0.7576, 0.0, 0.6527, 0.0], None),
